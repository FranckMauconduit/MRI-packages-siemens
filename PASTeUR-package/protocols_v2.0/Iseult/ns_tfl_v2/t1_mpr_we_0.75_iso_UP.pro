...
tProtocolName	 = 	"t1_mpr_we_0.75_iso_UP"
...
dAveragesDouble	 = 	1.0
lScanTimeSec	 = 	353
lTotalScanTimeSec	 = 	355
dRefSNR	 = 	118507.793894
dRefSNR_VOI	 = 	118507.793894
ucMotionCorr	 = 	1
ucCineMode	 = 	1
ucSequenceType	 = 	1
ucCoilCombineMode	 = 	1
...
sTXSPEC.aRFPULSE[0].flAmplitudeNL	 = 	3.40653991699
sTXSPEC.aRFPULSE[1].flAmplitudeNL	 = 	1.03999996185
sTXSPEC.aRFPULSE[2].flAmplitudeNL	 = 	426.250854492
sTXSPEC.aRFPULSE[3].flAmplitudeNL	 = 	20.648147583
sTXSPEC.aRFPULSE[4].flAmplitudeNL	 = 	20.648147583
sTXSPEC.aTxScaleFactor.__attribute__.size	 = 	16
sTXSPEC.aPTXRFPulse.__attribute__.size	 = 	1
sTXSPEC.aPTXRFPulse[0].lPulseType	 = 	2
...
sKSpace.lBaseResolution	 = 	340
sKSpace.lPhaseEncodingLines	 = 	340
...
sCoilSelectMeas.dOverallImageScaleFactor	 = 	0.00555555555556
